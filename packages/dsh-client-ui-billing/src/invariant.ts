...
/**
 * No runtime invariant: the plugin owns a single read-only dock registration
 * whose disposal is proven by the HMR-safety spec — it owns no store (state
 * arrives on the billing projection), emits no cordis events, and holds no
