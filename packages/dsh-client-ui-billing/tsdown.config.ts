...
const PLUGIN_ID = 'dsh-client-ui-billing'
const COMMUNITY_PLUGIN_ID = 'dsh-billing-community-bundle'
...
export default defineConfig([
  ...
  {
    name: `${COMMUNITY_PLUGIN_ID}/client`,
    entry: { 'community-client': 'lib/types/client/index.js' },
    outDir: 'lib',
    format: 'cjs',
    platform: 'browser',
    sourcemap: true,
    ...
    plugins: [createCssPlugin(COMMUNITY_PLUGIN_ID)],
    outputOptions: {
      entryFileNames: 'community-client.js',
      banner: `window.__ModuleLoader__.load({ id: ${JSON.stringify(COMMUNITY_PLUGIN_ID)}, factory: (require) => {`,
      footer: 'return module.exports; } });',
      intro: 'var module = { exports: {} }; var exports = module.exports;',
    },
  },
